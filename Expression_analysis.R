...
#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::#
# Working with genes deferentially expressed in at least one stage shared in the two species. #
#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::#
shared_ort <- venn_ortho[venn_ortho$pepper == T & venn_ortho$tomato == T,]

list <- uniprot_ort %>% mutate(filt=ifelse(ortho %in% 
                                             shared_genes$ortho, "yes","no")) %>% filter(filt=="yes") %>%
...
#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::#
# Working with genes deferentially expressed in at least one stage only in a specie.          #
#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::#
